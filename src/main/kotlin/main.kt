fun main(args: Array<String>){
    ...
    println(arr.contentToString()) // one way of printing out reversed array

    // or

    for (eachElement in arr){ // another way of printing out reversed array
        print("$eachElement ")
    }
...
fun <T> Array<T>.ourVersionReverse(fromIndex: Int = 0) {
    ...
    // Here is the actual reverse work
...
fun checkRangeIndexes(fromIndex: Int, size: Int) {
    ...
    // Here i check whether the indexes are acceptable
